...
def run_kicks():  
    ...
    print("Kicks have been written to entire_summary.csv")
...
def run_warns():
    ...
    print("Warns have been written to entire_sumamry.csv")
    # print("if you see this it means that the code didn't error out... good job!")
...
def run_mutes():
    ...
    print("Mutes have been written to entire_summary.csv")
...
def run_bans():
    ...
    print("Bans have been written to entire_summary.csv")
    # print("if you see this it means that the code didn't error out... good job!")
